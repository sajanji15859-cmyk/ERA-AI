...
EXPECTED_RISK: dict[str, RiskLevel] = {
    ...
    "browser.inspect": RiskLevel.SAFE,
    "browser.tabs": RiskLevel.SAFE,
    "browser.activate_tab": RiskLevel.SENSITIVE,
    "browser.download": RiskLevel.MUTATING,
    "browser.upload": RiskLevel.MUTATING,
    "browser.workflow_run": RiskLevel.MUTATING,
...
EXPECTED_DOMAIN: dict[str, str] = {
    ...
    "browser.activate_tab": "browser",
    "browser.download": "browser",
    "browser.upload": "browser",
    "browser.workflow_run": "browser",
    "email.read": "email",
    "email.search": "email",
    "email.draft": "email",
    "email.send": "email",
...
EXPECTED_SECRETS: dict[str, frozenset[str]] = {
    ...
    "browser.download": frozenset(),
    "browser.upload": frozenset(),
    "browser.workflow_run": frozenset(),
